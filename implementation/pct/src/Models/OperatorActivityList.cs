...
namespace Your
{
    ...
    {
        public static ObservableCollection<OperatorActivity> OperatorActivities { get; set; }
        ...
        {
            foreach (var operatorActivity in OperatorActivities)
            {
                if (operatorActivity.Uuid == s)
                {
